      ...
      <div class="dropdown-container">
        <div class="dropdown-wrapper">
          <div class="dropdown" onclick="toggleDropdownEstado()">
            <span id="selectedEstado"><?= $estado_filtro ? ucfirst($estado_filtro) : ($lang['filtrar_estado'] ?? 'Estado') ?></span>
            <span class="arrow">▼</span>
          </div>
...
?>
  <div class="ficha-card" data-jornada="<?= strtolower($row['Jornada']) ?>">
      ...
      <p><strong><?= $lang['estado'] ?? 'Estado' ?>:</strong> <span class="estado-text"><?= htmlspecialchars($estado) ?></span></p>
